...
public class QuiteLogicalClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        // [KR] 핵심: 레일 투명도 처리를 위한 렌더 레이어 등록
        // [EN] Essential: Register render layers for rail transparency
        qlogic$registerRenderLayers();
    ...
    /**
     * [KR] 모든 구리 레일 블록을 투명(CUTOUT) 레이어로 지정하여 텍스처 깨짐 방지
     */
    private void qlogic$registerRenderLayers() {
        // [KR] 제공된 Fabric API 구조에 맞춰 static 메서드 및 ChunkSectionLayer 사용
        // [EN] Use static methods and ChunkSectionLayer according to provided Fabric API structure
        BlockRenderLayerMap.putBlocks(ChunkSectionLayer.CUTOUT,
                ModBlocks.EXPOSED_POWERED_RAIL,
                ModBlocks.WEATHERED_POWERED_RAIL,
                ModBlocks.OXIDIZED_POWERED_RAIL,
                ModBlocks.WAXED_POWERED_RAIL,
                ModBlocks.WAXED_EXPOSED_POWERED_RAIL,
                ModBlocks.WAXED_WEATHERED_POWERED_RAIL,
                ModBlocks.WAXED_OXIDIZED_POWERED_RAIL
        );
    }
